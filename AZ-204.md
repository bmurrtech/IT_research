...
- Azure Functions is an alternative to WebJobs, but considered the default choice for most cases. Azure functions can Integrate with many different services, both within azure and from 3rd parties.
